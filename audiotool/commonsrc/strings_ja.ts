...
export const JA_STRINGS: ELocaleString[] = [
  ...
  <div class=title
>Google Project Euphonia：関心フォーム</div>
...
>ニックネーム、ファースト＆amp;姓、単なる名前など。</div>
<input id=ifname class=formtext />
</div>

<div class=formbox>
<div class=fieldname><label for=ifcountry
>あなたはどの国に住んでいますか？</label>
<span class=required>*</span></div>
<div class=fielddescription
>重要なことに注意してください：私たちは残念ながら、この時点でアスタリスク（*）で以下に示す国の住民にギフトカードを送ることができません。これらの国のいずれかに居住している場合は、プロジェクトユーフォニアの研究に参加することを歓迎します。ギフトカードを受け取ることができるかどうか、いつでもいつ通知します。
</div>
...
>このプロジェクトについて聞いたことを教えてください</label>
<span class=optional
>（オプション）</span>
</div>
...
>マイクとスピーカーを装備したインターネット接続コンピューター</label>
</div>
<div class=checkboxrow>
<input type=checkbox id=ifdeviceandroid />
<label for=ifdeviceandroid
>Android電話またはタブレット（Samsung、Pixel、Nexusなど）</label>
</div>
<div class=checkboxrow>
...
<div class=formbox>
<div class=fielddescription>
あなたを助けている人について少し教えてください。そうすれば、私たちはあなたの両方と連絡を取り合うのに最適です。アシスタントの名前を含めることにより、彼らはこのプロジェクトへの参加に関する情報を受け取ることを理解しています。複数のアシスタントと電子メールをリストすることができます。それぞれをコンマで分離するだけです。
</div>
</div>
...
>この人のあなたとの関係は何ですか？</label>
<span class=optional
>（オプション）</span>
</div>
<div class=fielddescription
>例：介護者、友人、家族、言語療法士など</div>
...
<div class=fieldname
>敏感な個人識別可能な情報のアンケートコレクション</div>
<div class=fielddescription>
このアンケートの目的は、Googleとの今後のデータ収集努力の適格性を確認することです。コレクションの目的は、Googleが現在および将来の製品とサービスのアクセシビリティを設計、研究、開発、構築、および改善するのを支援することです。スピーチテクノロジーへ。
このアンケートで提供する情報は、参加するために選択されている場合、データ収集中に提供することを選択した他の情報およびデータと組み合わせることができます。
</div>
</div>

<div class=formbox>
<div class=fieldname>
ご承認支援技術、言語障害または障害、および言語パターンの使用。
...
>規約と条件</a>
私の情報は、音声関連技術の製品調査、開発、改善に使用され、に従って使用されることを認めます。
...
<div class=forminfobox>
<div class=fieldname>
このフォームを送信することにより、Googleとその関連会社にメールで連絡することに同意します。
</div>
</div>
